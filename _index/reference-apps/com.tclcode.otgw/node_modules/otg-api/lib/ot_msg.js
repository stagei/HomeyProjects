var otMsg = {
	...
	*/
	Messages: { // OpenTherm messages
		...
		// Unchecked messages
		'34': {
			en: "Boiler heat exchanger temperature",
			dir: "R-", val: "s16", var: "BoilerHeatExchangerTemperature", sensor: "temperature"
		},
		// 35: Boiler fan speed Setpoint and actual value
		'35': {
			en: "Boiler fan speed Setpoint and actual value",
			dir: "R-", val: "s8", var: { hb: "BoilerFanSpeedSetpoint", lb: "BoilerFanSpeedValue" }
		},
		// 36: Electrical current through burner flame [µA]
		'36': {
			en: "Electrical current through burner flame", nl: "Brander stroom",
			dir: "-W", val: "f8.8", var: "BurnerElectricalCurrent"
		},
		// 37: Room temperature for 2nd CH circuit (°C)
		'37': {
			en: "Room temperature 2nd circuit", nl: "Kamertemperatuur 2de circuit",
			dir: "-W", val: "f8.8", var: "CurrentTemperatureCH2", sensor: "temperature"
		},
		...
		'48': {
			...
			dir: "R-", val: "s8", var: { hb: "DHWBounadryHigh", lb: "DHWBounadryLow" }, sensor: "temperature"
		},
		'49': {
			en: "Max. central heating setpoint boundaries",
			dir: "R-", val: "s8", var: { hb: "CHBoundaryHigh", lb: "CHBoundaryLow" }, sensor: "temperature"
		},
		'50': {
			en: "OTC heat curve ratio upper & lower bounds",
			dir: "R-", val: "s8", var: { hb: "OTCBoundaryHigh", lb: "OTCBoundaryLow" }
		},
		'56': {
		...
		'78': {
			en: "Relative humidity exhaust air", nl: "Luchtvochtigheid luchtuitlaat",
			dir: "RW", val: "u8", var: { hb: "RelativeHumidityExhaust" }, sensor: "humidity"
		},
		'79': {
		...
		'98': {
			en: "RF sensor strength and battery level",
			dir: "R-", val: "u8", var: { hb: "RfSensorStength", lb: "RfSensorBatteryLevel" }
		},
		// 99: Operating Mode HC1, HC2/ Operating Mode DHW
		'99': {
			en: "Operating Mode HC1, HC2/ Operating Mode DHW",
			dir: "R-", val: "u8", var: { hb: "OperatingModeHC1HC2", lb: "OperatingModeDhw" }
		},
		// OpenTherm 2.2 IDs
		...
		// ID101:LB45: Slave Solar Storage: Solar status
		'101': {
			en: "Solar storage mode and status",
			dir: "R-", val: "u8", var: { hb: "MasterSolarStorage", lb: "SlaveSolarStorage" }
		},
		// ID102: Application-specific fault flags and OEM fault code Solar Storage
		'102': {
			en: "Solar storage fault flags",
			dir: "R-", val: "flag8", lb: "u8", var: { hb: "SolarStorageFaultFlags", lb: "SolarStorageFaultCode" }
		},
		// ID103:HB0: Slave Configuration Solar Storage: System type
		// ID103:LB: Slave MemberID Code Solar Storage
		'103': {
			en: "Solar storage slave configuration",
			dir: "R-", val: { hb: "flag8", lb: "u8" }, flags: "SolarStorageSlaveConfigFlags", var: { lb: "SolarStorageSlaveMemberId" }
		},
		// ID104: Solar Storage product version number and type
		'104': {
			en: "Solar storage product version and type",
			dir: "-W", val: "u8", var: { hb: "SolarStorageProductType", lb: "SolarStorageProductVersion" }
		},
		// ID105: Number of Transparent-Slave-Parameters supported by TSP’s Solar Storage
		'105': {
			en: "Number of Transparent-Slave-Parameters (TSP) supported by Solar Storage",
			dir: "R-", val: "u16", var: "SolarStorageTSPSize", sensor: "counter"
		},
		// ID106: Index number / Value of referred-to transparent TSP’s Solar Storage parameter
		'106': {
			en: "Index number / Value of referred-to transparent TSP’s Solar Storage parameter",
			dir: "R-", val: "u16", var: "SolarStorageTSPIndex", sensor: "counter"
		},
		// ID107: Size of Fault-History-Buffer supported by Solar Storage
		'107': {
			en: "Size of Fault-History-Buffer supported by Solar Storage",
			dir: "R-", val: "u16", var: "SolarStorageFHBSize", sensor: "counter"
		},
		// ID108: Index number / Value of referred-to fault-history buffer entry Solar Stor
		'108': {
			en: "Index number / Value of referred-to fault-history buffer entry Solar Storage",
			dir: "R-", val: "u16", var: "SolarStorageFHBIndex", sensor: "counter"
		},
		// ID109: Electricity producer starts
		'109': {
			en: "Electricity producer starts",
			dir: "R-", val: "u16", var: "ElectricityProducerStarts", sensor: "counter"
		},
		// ID110: Electricity producer hours
		'110': {
			en: "Electricity producer hours",
			dir: "R-", val: "u16", var: "ElectricityProducerHours", sensor: "counter"
		},
		// ID111: Electricity production
		'111': {
			en: "Electricity production",
			dir: "R-", val: "u16", var: "ElectricityProduction", sensor: "counter"
		},
		// ID112: Cumulative Electricity production
		'112': {
			en: "Cumulative electricity production",
			dir: "R-", val: "u16", var: "ElectricityProductionCumulative", sensor: "counter"
		},
		// ID113: Number of un-successful burner starts
		'113': {
			en: "Number of un-successful burner starts",
			dir: "R-", val: "u16", var: "BurnerStartsUnsuccessfulCount", sensor: "counter"
		},
		// ID114: Number of times flame signal was too low
		'114': {
			en: "Number of times flame signal was too low",
			dir: "R-", val: "u16", var: "FlameSignalTooLowCount", sensor: "counter"
		},
		'115': {
		...
		/*
		(only used/valid when MemberID of 11 is returned with Data-ID 3)
